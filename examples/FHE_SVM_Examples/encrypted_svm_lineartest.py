...
def setup_crypto_context(multDepth=1, scalSize=30, firstModSize=70, securityLevel=128, batchSize=1024, ringDim=16384):
    """
...
def run_encrypted_svm(trials=100, csv_filename="svm_results-linear.csv"):
    ...
    with open(csv_filename, mode='a', newline='') as file:
        ...
        writer.writerow([1, 30, 70, 128, 1024, 16384, avg_encrypted_acc, avg_non_encrypted_acc, avg_encrypted_time, avg_non_encrypted_time])
