...
int main(int argc, char* argv[]) {
    ...
    cc->Enable(MULTIPARTY);
      ...
      // Data encoding
        ...
        std::vector<int64_t> vector1 = split(s1);
        std::vector<int64_t> vector2 = split(s2);
        std::vector<int64_t> vector3 = split(s3);
        ...
        Plaintext plaintextevalmult;
            ...
            plaintext1 = cc->MakePackedPlaintext((vector1));
            plaintext2 = cc->MakePackedPlaintext((vector2));
            plaintext3 = cc->MakePackedPlaintext((vector3));
       ...
       // Decrypt after homomorphic
        ...
        std::cout << "Expected: " << plaintextevaladd->GetPackedValue() << std::endl;
           std::cout << "Multiparty: " << plaintextMultipartyNew->GetPackedValue() << std::endl;     

        std::cout << "\nMultiparty: multiplication"  << std::endl;
        std::cout << "Expected: " << plaintextevalmult->GetPackedValue() << std::endl;
           std::cout << "Multiparty: " << plaintextMultipartyMult->GetPackedValue() << std::endl;     
