...
int main(int argc, char *argv[]) {
    ...
    auto bin1_0 = cc.Encrypt(cc.GetPublicKey(), bin1[0]);
     auto bin1_1 = cc.Encrypt(cc.GetPublicKey(), bin1[1]);
   auto bin1_2 = cc.Encrypt(cc.GetPublicKey(), bin1[2]);
    auto bin1_3 = cc.Encrypt(cc.GetPublicKey(), bin1[3]);

        auto bin2_0 = cc.Encrypt(cc.GetPublicKey(), bin2[0]);
     auto bin2_1 = cc.Encrypt(cc.GetPublicKey(), bin2[1]);
   auto bin2_2 = cc.Encrypt(cc.GetPublicKey(), bin2[2]);
    auto bin2_3 = cc.Encrypt(cc.GetPublicKey(), bin2[3]);
